...
from crypto_etps.sec_prospectus import resolve_s1_filing_url
...
class CryptoEtpRow:
    ...
    s1_filing_url: str  # newest S-1 primary doc, S-1 browse, or EDGAR search
...
def enrich_crypto_etps_rows(
    ...
    *,
    ...
    for r in enriched:
        s1 = resolve_s1_filing_url(r.symbol, ua)
        out.append(
            CryptoEtpRow(
                symbol=r.symbol,
                name=r.name,
