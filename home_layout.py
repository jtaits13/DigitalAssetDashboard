...
.stApp:has(.mock-tmmf-inner) .inner-rich-zone.etp-mock-zone {
  ...
  background: var(--hx-tmmf-soft, #f3f6f9);
  box-shadow:
    0 1px 2px rgb(var(--hx-tmmf-rgb, 62 92 116) / 0.05),
...
.stApp:has(.mock-tmmf-inner) .etp-mock-zone .home-zone__stripe {
  display: block;
  height: 4px;
  margin: 0;
  padding: 0;
...
.stApp:has(.mock-tmmf-inner) .etp-mock-zone .home-zone__badge {
  flex-shrink: 0;
  width: 2.4rem;
  height: 2.4rem;
  display: grid;
  ...
  color: #ffffff;
  background: var(--hx-tmmf-dark, #31485c);
  box-shadow: 0 2px 8px rgb(var(--hx-tmmf-rgb, 62 92 116) / 0.18);
}

.stApp:has(.mock-tmmf-inner) .inner-rich-zone.zone--tmmf .home-zone__titles,
.stApp:has(.mock-tmmf-inner) .etp-mock-zone .home-zone__titles {
  flex: 1;
  min-width: 0;
}

.stApp:has(.mock-tmmf-inner) .inner-rich-zone.zone--tmmf .page-intro__title,
.stApp:has(.mock-tmmf-inner) .etp-mock-zone .home-zone__titles .page-intro__title {
...
/* Streamlit splits KPI / methodology / Key Obs into sibling blocks — stack gap on containers. */
...
.stApp:has(.mock-tmmf-inner) [data-testid="stElementContainer"]:has(.methodology-panel) {
  ...
  padding-top: 0 !important;
  padding-bottom: 0 !important;
  margin-bottom: calc(var(--tmmf-kpi-stack-gap, 1.15rem) + var(--tmmf-stack-gap, 0.85rem)) !important;
}

.stApp:has(.mock-tmmf-inner) [data-testid="stElementContainer"]:has(.methodology-panel) + [data-testid="stElementContainer"]:has(.etp-mock-key-obs-block) {
  margin-top: 0 !important;
}

.stApp:has(.mock-tmmf-inner) [data-testid="stElementContainer"]:has(.rwa-kpi-panel-static) [data-testid="stHtml"] .rwa-kpi-panel-static,
.stApp:has(.mock-tmmf-inner) [data-testid="stElementContainer"]:has(.rwa-kpi-panel-static) .rwa-kpi-panel-static {
