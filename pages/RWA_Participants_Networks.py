...
def main() -> None:
    ...
    st.markdown(
        "**Key Observation**\n"
        "- RWA growth remains **network-concentrated**, so institutions often balance scale on leading chains with "
        "interoperability, governance, and counterparty-risk controls before broad multi-chain expansion."
    )
    st.divider()
