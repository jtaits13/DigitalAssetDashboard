...
from rwa_league.widgets import RWA_PLATFORMS_DATA_SOURCE_CAPTION, show_rwa_participants_platforms_widget
...
def main() -> None:
    ...
    render_subpage_top_bar()
    if st.button("← Home", key="top_home_rwa_participants_platforms"):
    ...
    st.markdown(
        '<p class="jd-hub-dek jd-hub-dek-fullbleed">RWA <strong>Participants</strong> · <strong>Platforms</strong>: '
        "issuer-level **Platforms overview** metrics and the **Platforms** table from "
