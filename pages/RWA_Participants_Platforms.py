"""Participants — Platforms: issuer overview KPIs + Platforms table (GitHub Pages parity iframe)."""
...
def main() -> None:
    ...
    with st.spinner("Loading Participants — Platforms…"):
        payload = get_rwa_asset_deep_payload("platforms")
    ...
    render_subpage_footer(label="Participants — Platforms")
