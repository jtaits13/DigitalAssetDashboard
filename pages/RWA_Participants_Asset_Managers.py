...
def main() -> None:
    ...
    st.markdown(
        "**Key Observation**\n"
        "- Asset-manager activity is still **top-heavy**, and near-term share shifts are most sensitive to advisor "
        "distribution reach, custody partner trust, and repeat issuance cadence."
    )
    st.divider()
